...
result_dir=/p/user_pub/e3sm/zhang40/e2c_testing
...
ncremap --map=${map_file} -v area,PHIS,LANDFRAC -I ${input_path} -O ${rgr_dir}/${exp}_${ens}/fixed_vars 

# CMORIZE Atmosphere fx variables
e3sm_to_cmip --realm fx -i ${rgr_dir}/${exp}_${ens}/fixed_vars -o $result_dir  -v areacella, sftlf, orog  -t /home/zhang40/cmip6-cmor-tables/Tables/ -u ${metadata_path}
...
# Note --start=$start --end=$end won't work with ncremap
#ncremap -P eam -j 1 --xtr_mth=mss_val --vrt_fl=/p/user_pub/e3sm/staging/resource/grids/vrt_remap_plev19.nc  -O ${rgr_dir}/${exp}_${ens} -v ${raw_var_list} -I ${rgr_dir_vert} ${flags}
