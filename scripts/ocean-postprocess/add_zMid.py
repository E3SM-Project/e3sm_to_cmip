...
def write_netcdf(ds, fileName, compression_type=None, compression_level=None):
    '''
    ...
    for variableName in variableNames:
        ...
        if compression_type and compression_level:
            encodingDict[variableName][compression_type] = True
            encodingDict[variableName]['complevel'] = str(compression_level)
...
def main():
    ...
    if args.compression_type and args.compression_level:
        write_netcdf(ds, args.outFileName, args.compression_type, args.compression_level)
    else:
